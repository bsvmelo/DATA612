...
We can see that the SVD model is the more accurate of the two. Next, we look at the RMSE, MSE and MAE. Again, SVD is the better model.  
...
Again, both the curve and the plot favor the SVD model.  
